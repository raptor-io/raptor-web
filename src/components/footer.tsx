// 导入 Next.js 的 Link 组件用于页面导航
import Link from "next/link";
import Image from "next/image";

// Footer 组件：网站的底部导航和信息展示区域
export function Footer() {
  return (
    // 主容器，使用 flex 布局并添加上下内边距
    <footer className="container mt-10 flex flex-wrap justify-between pb-16 pt-10">
      {/* 左侧区域：包含 logo 和社交媒体链接 */}
      <div className="flex basis-full justify-between gap-8 md:basis-auto md:flex-col md:justify-start">
        ...
        <div className="flex items-center gap-5">
          ...
          {/* Twitter 链接 */}
          <a href="https://x.com/raptoramm" className="text-muted-foreground hover:text-foreground">
      ...
      <div className="mt-10 flex basis-1/2 flex-col gap-5 md:mt-0 md:basis-auto">
        <h3 className="text-2xl font-semibold text-primary">Product</h3>
        {/* 社区链接 */}
      ...
      <div className="mt-10 flex basis-1/2 flex-col gap-5 md:mt-0 md:basis-auto">
        ...
        {/* 博客链接 */}
        <Link href="https://medium.com/@raptor-web" className="text-sm text-muted-foreground hover:text-foreground">
          Blog
        </Link>
        {/* 品牌链接 */}
        <Link href="#" className="text-sm text-muted-foreground hover:text-foreground">
      ...
      {/* 资源相关链接区域 */}
      <div className="mt-10 flex basis-1/2 flex-col gap-5 md:mt-0 md:basis-auto">
        <h3 className="text-2xl font-semibold text-primary">Resources</h3>
        {/* 联系方式链接 */}
        <Link href="#" className="text-sm text-muted-foreground hover:text-foreground">
          Contact
        </Link>
      ...
      {/* 法律相关链接区域 */}
      <div className="mt-10 flex basis-1/2 flex-col gap-5 md:mt-0 md:basis-auto">
        <h3 className="text-2xl font-semibold text-primary">Legal</h3>
        {/* 隐私政策链接 */}
        <Link href="#" className="text-sm text-muted-foreground hover:text-foreground">
          Privacy Policy
        </Link>
